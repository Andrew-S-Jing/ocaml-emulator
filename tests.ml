...
let tests =
  [
    ...
    "Plus 1 1", Binop (Plus, Num 1, Num 1), "2";
    "Plus ~-4 x", Binop (Plus, Num ~-4, Var "x"), "(~-4 + x)";
    "Minus 1 1", Binop (Minus, Num 1, Num 1), "0";
    "Minus x ~-1", Binop (Minus, Var "x", Num ~-1), "(x - ~-1)";
    "Times 2 ~-2", Binop (Times, Num 2, Num ~-2), "~-4";
    ...
    "Unassigned", Unassigned, "unbound variable";
    "App (fun x -> x + 1) 2",
